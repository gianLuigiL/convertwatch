    ...
    return (
        <div className="data_holder">
            ...
            <div className="breakdown">
                ...
                <p>This means that the more you increase the margin, the more you expect the foreign currency to be weak against yours, and the higher you go the unlikelier it gets.</p>
            </div>
        </div>
    )
}